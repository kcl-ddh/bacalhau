# -*- coding: utf-8 -*-
#
# Bacalhau documentation build configuration file, created by
...
sys.path.insert(1, os.path.abspath('../bacalhau'))
...
project = u'Bacalhau'
copyright = u'2012, Miguel Vieira'
